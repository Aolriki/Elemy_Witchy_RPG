...
public class MoveState : State
{
    ...
    {
        //max to guarantee that the parameter won't be below the minimum to play the run animation
        GraphicContext.animator.SetFloat("Speed X", Mathf.Max(0.1f, Mathf.Abs(PhysicsContext.rb.linearVelocity.x)));
    }
